...
def preprocess(dataset_path):
    ...
    Steps:
    #read the midi songs from the data_path
    ...
    for song in initial_songs:
        ...
        songs.append(song)
    print("{} songs loaded and with duration corrected".format(len(songs)))
...
def create_mapping(songs, mapping_json_name):
    ...
    print("VOCAB_LENGTH:", len(vocabulary))
...
if __name__=="__main__":
    ...
    single_file_song = songs= create_single_file_dataset(configure.SAVE_DIR,configure.SINGLE_FILE_PATH, configure.SEQUENCE_LENGTH)
    all_keys_vocabulary = list(set(single_file_song))
